...
<title>Edit Job Listing - JobMatch</title>
...
<div class="create-job-container">
  ...
  <form method="POST" action="<?= site_url('edit_jobpost/' . $job['id']); ?>">


    <!-- Company Name -->
    <div class="mb-3">
      <label class="form-label">Company Name</label>
      <input type="text" name="company_name" class="form-control" value="<?php echo htmlspecialchars($company_name); ?> " readonly>
    </div>
    ...
    <div class="mb-3">
      ...
      <div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="job_type" id="fullTime" value="Full-Time" <?php if($job['job_type']=='Full-Time') echo 'checked'; ?>>
          <label class="form-check-label" for="fullTime">Full-Time</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="job_type" id="partTime" value="Part-Time" <?php if($job['job_type']=='Part-Time') echo 'checked'; ?>>
          <label class="form-check-label" for="partTime">Part-Time</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="job_type" id="gig" value="Gig" <?php if($job['job_type']=='Gig') echo 'checked'; ?>>
    ...
    <div class="mb-4">
      ...
      <input type="text" name="salary_range" class="form-control" value="<?= htmlspecialchars($job['salary_range']); ?>" placeholder="e.g. ₱20,000 - ₱30,000">
    </div>

    <!-- Buttons -->
    <div class="d-flex justify-content-center gap-3">
      <button type="submit" class="btn-confirm w-50">Save Changes</button>
